 ...
 * 台账收入明细
 */
public class TzsrmxPage extends PkhBasePage {

    public TzsrmxPage(Context context) {
        this(context, null);
    }

    public TzsrmxPage(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TzsrmxPage(Context context, AttributeSet attrs, int defStyle) {
